    ...
    <div class="col-12 vh-100">
      <div id="admin-links" class="d-flex align-items-center justify-content-center flex-column w-100 h-100">
        ...
        <?php else : ?>
          ...
          <div class="table-responsive w-100" id="links-table">
            <table class="table">
              ...
              <tbody>
                <?php foreach ($links as $index => $link) : ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <a href="/admin/links/update/<?= $link["id"] ?>" class="btn m-2 btn-dark rounded-pill badge-success text-light"><i class="bi bi-arrow-clockwise"></i></a>
