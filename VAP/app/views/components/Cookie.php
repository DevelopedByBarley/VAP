<link rel="stylesheet" href="/public/css/components/cookie.css?v=<?php echo time() ?>">

<div id="cookie-consent" class="container cookie-banner_wrapper cookie-banner_bottomright zone-hidden pr-color p-5 d-flex">
    <div class="row">
