...
<div class="d-flex align-items-center flex-column justify-content-center vh-100 container">
  ...
  <div class="row d-flex align-items-center flex-column r-border p-3 w-100" id="user-documents">
    <div class="head p-1">
      <h1 class="text-center text-lg-start my-5"><?= UPLOADED_DOCUMENTS["title"][$lang] ?? 'HIBA' ?></h1>
    </div>

    <div class="row p-0 d-flex align-items-center justify-content-center" style="min-height: 30vh">
      <div class="col-12">
            ...
            <tbody>
              <?php foreach ($documents as $index => $document) : ?>
                ...
                <tr>
                  ...
                  <td><a href="/public/assets/uploads/documents/users/<?= $document["name"] ?>" class="btn btn-dark" download><?= UPLOADED_DOCUMENTS["download"][$lang] ?? 'HIBA' ?></a></td>
                </tr>
      ...
      <?php if (count($documents) !== 2) : ?>
        <div class="mt-5 text-center">
          <a href="/user/documents/new" class="btn btn-outline-dark"><?= UPLOADED_DOCUMENTS["add_document"][$lang] ?? 'HIBA' ?></a>
        </div>
      <?php endif ?>
    </div>
  </div>
