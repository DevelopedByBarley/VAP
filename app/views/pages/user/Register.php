    ...
    <div class="row mb-4 mt-5 m-1">
      ...
      <div class="col-xs-12 col-md-6 mt-3">
        <div class="form-outline mb-4">
          ...
          <input type="email" id="email" name="email" class="form-control <?= (!isset($errors["email"])) ? '' : 'border border-danger'  ?> <?= (!isset($errors["email"])) && isset($prev["email"]) ? 'border border-success' : ''  ?>" required value="<?= $prev["email"] ?? '' ?>" placeholder="<?= REGISTRATION["form"]["email"][$lang] ?? 'HIBA' ?>" />
      ...
      <div class="col-xs-12 col-md-6 mt-3">
        <div class="form-outline mb-4">
          ...
          <input type="password" id="password" name="password" class="form-control <?= (!isset($errors["password"])) ? '' : 'border border-danger'  ?> <?= (!isset($errors["password"])) && isset($prev["password"]) ? 'border border-success' : ''  ?>" required placeholder="<?= REGISTRATION["form"]["password"][$lang] ?? 'HIBA' ?>" value="<?= $prev["password"] ?? '' ?>"" />
