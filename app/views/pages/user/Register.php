    ...
    <div class="row mb-4 mt-5 m-1">
      ...
      <div class="col-xs-12 col-md-6 mt-3">
        <div class="form-outline mb-4">
          ...
          <input type="password" id="password" name="password" class="form-control" required placeholder="<?= REGISTRATION["form"]["password"][$lang] ?? 'HIBA' ?>" />
        </div>
      </div>
      ...
      <div class="col-xs-12 col-md-6 mt-3">
        <div class="form-outline mb-4">
          ...
          <input type="text" id="phone" name="mobile" class="form-control" value="<?= $prev["mobile"] ?? '' ?>" placeholder="<?= REGISTRATION["form"]["mobile"][$lang] ?? 'HIBA' ?>" />
        </div>
      </div>
