                ...
                <?php foreach ($subscriptions as $subscription) : ?>
                  ...
                  <div class="col-12 mt-3">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteSubModal<?= $subscription["eventId"] ?>">
                          Jelentkezés törlése
                        </button>
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#subModal<?= $subscription["eventId"] ?>">
                          Áttekintés
                        </button>
                      </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="subModalLabel<?= $subscription["eventId"] ?>">Áttekintés</h5>
                        ...
                        <div class="modal-body">
                          <div class="row">
                            ...
                            <h1 class="mt-2"><?= $subscription[languageSwitcher("name")] ?></h3>
                            </div>
                          </div>
                          <hr>
                          <div>
                  ...
                  <div class="modal fade" id="deleteSubModal<?= $subscription["eventId"] ?>" tabindex="-1" aria-labelledby="deleteSubModalLabel<?= $subscription["eventId"] ?>" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="deleteSubModalLabel<?= $subscription["eventId"] ?>">Regisztráció törlése</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
