    ...
    <div class="col-12 vh-100 d-flex align-items-center justify-content-center w-100">
      <div id="admin-documents" class="d-flex align-items-center justify-content-center flex-column w-100">
        ...
        <?php else : ?>
          ...
          <div class="table-responsive w-100" id="documents-table">
            <table class="table">
              ...
              <tbody>
                <?php foreach ($documents as $index => $document) : ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <a href="/admin/documents/update/<?= $document["id"] ?>" class="btn m-2 btn-dark rounded-pill badge-success text-light"><i class="bi bi-arrow-clockwise"></i></a>
